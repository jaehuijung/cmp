...
public interface rackMapper {
	...
	// 선번장관리 > 선번장목록 > 리스트 목록
	public List<Map<String, Object>> getRackTotalList(Map<String, Object> paramMap);

	// 선번장관리 > 선번장목록 > 리스트 개수
	public int getRackTotalListCnt(Map<String, Object> paramMap);
	...
	public int checkInsertListToContainRack(Map<String, Object> paramMap);

	// 선번장관리 > 선번장목록 > 추가 > 선번장 저장시 필요한 일련번호인 장비관리번호 생성
	public String generateRackManageId(Map<String, Object> paramMap);

	// 선번장관리 > 선번장목록 > 추가 > 선번장 정보 저장
	public void saveRackInfo(Map<String, Object> paramMap);

	// 선번장관리 > 선번장목록 > 수정/상세 > 선번장 상세 정보 (포설년도, 회선정보)
	public Map<String, Object> getRackDetailLinkList(String cableManageId);
	...
	public List<Map<String, Object>> getRackDetailTotalList(Map<String, Object> paramMap);
	 ...
	 */
	public void deleteRackList(String deleteCableTarget);
}
