...
--
-- Table structure for table `autocarqr`
--

DROP TABLE IF EXISTS `autocarqr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `autocarqr` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `sRackNumber` varchar(100) NOT NULL,
  `sRackLocation` varchar(100) NOT NULL,
  `sServerName` varchar(100) NOT NULL,
  `sPortNumber` varchar(100) NOT NULL,
  `eRackNumber` varchar(100) NOT NULL,
  `eRackLocation` varchar(100) NOT NULL,
  `eServerName` varchar(100) NOT NULL,
  `ePortNumber` varchar(100) NOT NULL,
  `qrStart` varchar(100) NOT NULL,
  `qrEnd` varchar(100) NOT NULL,
  `qrStartImage` varchar(100) NOT NULL,
  `qrEndImage` varchar(100) NOT NULL,
  PRIMARY KEY (`idx`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `autocarqr`
--

LOCK TABLES `autocarqr` WRITE;
/*!40000 ALTER TABLE `autocarqr` DISABLE KEYS */;
INSERT INTO `autocarqr` VALUES (8,'1gg','283','3','495','5ii','5486','7','tuu','1$2$3$4','5$6$7$8','\\qrImg\\1$2$3$4.jpg','\\qrImg\\5$6$7$8.jpg'),(11,'135278','200','352','406yuity','i885','6','7','8','1$2$3$4','5$6$7$8','\\qrImg\\1$2$3$4.jpg','\\qrImg\\5$6$7$8.jpg'),(12,'26','264','2462','hjkhj','2342','341235','216236','2345','26$264$2462$23','2342$341235$216236$2345','\\qrImg\\26$264$2462$23.jpg','\\qrImg\\2342$341235$216236$2345.jpg'),(13,'t3t2iii','t23','t23t2','3rt23r','23423','4r234r','23r','uu24','t3t2$t23$t23t2$3rt23r','23423$4r234r$23r$324r4r','\\qrImg\\t3t2$t23$t23t2$3rt23r.jpg','\\qrImg\\23423$4r234r$23r$324r4r.jpg'),(14,'aaa','awwiiw','wer','tyewryer','njnghnm','mm','mhgm','yyy','aaa$awww$wer$tyewryer','njnghnm$mm$mhgm$yyy','\\qrImg\\aaa$awww$wer$tyewryer.jpg','\\qrImg\\njnghnm$mm$mhgm$yyy.jpg');
/*!40000 ALTER TABLE `autocarqr` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `equipment_link`
--

LOCK TABLES `equipment_link` WRITE;
/*!40000 ALTER TABLE `equipment_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `equipment_link` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `equipment_regist_hw` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `eqp_manage_id` varchar(10) NOT NULL COMMENT '장비 관리번호',
  `hw_manage_id` varchar(10) NOT NULL COMMENT 'HW 장비연결 관리번호',
  `hw_port` varchar(20) DEFAULT NULL COMMENT 'HW 장비 연결정보 포트',
  PRIMARY KEY (`idx`),
  KEY `equipment_regist_hw_ibfk_1` (`eqp_manage_id`),
  KEY `equipment_regist_hw_ibfk_2` (`hw_manage_id`),
  CONSTRAINT `equipment_regist_hw_ibfk_1` FOREIGN KEY (`eqp_manage_id`) REFERENCES `equipment_basic` (`eqp_manage_id`),
  CONSTRAINT `equipment_regist_hw_ibfk_2` FOREIGN KEY (`hw_manage_id`) REFERENCES `equipment_basic` (`eqp_manage_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='HW 장비에 등록된 HW장비 정보 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='HW 장비에 등록된 SW장비 정보 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exceldata` VALUES (1,'excelA1','excelB1','excelC1'),(2,'excelA2','excelB2','excelC2'),(3,'excelA3','excelB4','excelC4'),(4,'excelA4','excelB4','excelC4'),(5,'excelA5','excelB5','excelC5');
...
--
-- Table structure for table `qrcol`
--

DROP TABLE IF EXISTS `qrcol`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qrcol` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qrcol`
--

LOCK TABLES `qrcol` WRITE;
/*!40000 ALTER TABLE `qrcol` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrcol` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `qrlog` (
  ...
  `RackLocation` varchar(100) NOT NULL,
...
INSERT INTO `qrlog` VALUES (1,'test','192.168.0.1','2023-07-03 22:33:55','1','1','11','1'),(2,'test','192.168.0.1','2023-07-03 22:34:04','1a','2a','3a','4a'),(3,'test','192.168.0.1','2023-07-03 22:34:14','2b','3b','4b','5b'),(4,'test','192.168.0.1','2023-07-03 22:34:16','5','6','7','8'),(5,'test','192.168.0.1','2023-07-03 22:34:18','5a','6a','7a','8a'),(6,'test','192.168.0.1','2023-07-03 22:34:20','6b','7b','8b','9b'),(7,'test','192.168.0.1','2023-07-03 22:34:21','11','22','33','44'),(8,'test','192.168.0.1','2023-07-03 22:34:23','26','264','2462','23'),(9,'test','192.168.0.1','2023-07-03 22:34:25','77','2','3','4'),(10,'test','192.168.0.1','2023-07-03 22:34:27','njnghnm','mm','mhgm','yyy'),(11,'test','192.168.0.1','2023-07-03 22:34:29','1a','2a','3a','4a'),(12,'test','192.168.0.1','2023-07-03 22:34:32','z3','z1','z2','z7'),(19,NULL,'192.168.0.1','2023-07-04 22:51:14','1','2','3','4'),(20,NULL,'192.168.0.1','2023-07-04 22:52:37','1','2','3','4'),(21,'test','192.168.0.1','2023-07-04 22:53:05','1','2','3','4'),(22,'test','192.168.0.1','2023-07-04 22:53:07','1','2','3','4'),(23,'test','192.168.0.1','2023-07-04 22:53:13','1','2','3','4'),(24,'test1','192.168.0.1','2023-07-04 22:53:28','1','2','3','4'),(25,'test1','223.39.192.146','2023-07-04 22:53:49','1','2','3','4');
...
--
-- Dumping data for table `qruser`
--

LOCK TABLES `qruser` WRITE;
/*!40000 ALTER TABLE `qruser` DISABLE KEYS */;
INSERT INTO `qruser` VALUES (2,'test','$2a$10$ilIw8oRIUMfvybqgaXPHc.o1W0hGFjF1aMh2OEZTivTtnSJqZak2.','명회','gumh@seolimict.co.kr','01026906894'),(3,'test1','$2a$10$11vqLRM.us2zCWji74rij.4HJphA/L3TeLMVerNRGxhoiyzUieAU6','','',''),(4,'test3','$2a$10$t4iC1Yd319N7JpEInFbAtefVnQTLPn9nnC/o3oaPDxv5yX.8LLtqC','','',''),(5,'test11','$2a$10$IAuIc9qnS6LiNdoodanjj.K0/l1/L10mONq0wp11B4jAEWhrq6tYe','a','b','01026262626');
/*!40000 ALTER TABLE `qruser` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `slqrcol`
--

DROP TABLE IF EXISTS `slqrcol`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slqrcol` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `sRackNumber` varchar(100) NOT NULL,
  `sRackLocation` varchar(100) NOT NULL,
  `sServerName` varchar(100) NOT NULL,
...
--
-- Dumping data for table `slqrcol`
--

LOCK TABLES `slqrcol` WRITE;
/*!40000 ALTER TABLE `slqrcol` DISABLE KEYS */;
/*!40000 ALTER TABLE `slqrcol` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-25  7:22:47
