...
--
-- Table structure for table `equipment_connect`
--

DROP TABLE IF EXISTS `equipment_connect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `equipment_connect` (
  `eqp_manage_id` varchar(10) NOT NULL COMMENT '장비관리번호 (장비구분2 + 포설년도4 + 일련번호4)',
  `eqp_link_manage_id` varchar(10) NOT NULL COMMENT '장비 연결정보 관리번호 (장비구분2 + 포설년도4 + 일련번호4)',
  `port` varchar(30) DEFAULT NULL COMMENT '포트번호',
  KEY `equipment_connect_ibfk_1` (`eqp_manage_id`),
  KEY `equipment_connect_ibfk_2` (`eqp_link_manage_id`),
  CONSTRAINT `equipment_connect_ibfk_1` FOREIGN KEY (`eqp_manage_id`) REFERENCES `equipment_basic` (`eqp_manage_id`),
  CONSTRAINT `equipment_connect_ibfk_2` FOREIGN KEY (`eqp_link_manage_id`) REFERENCES `equipment_basic` (`eqp_manage_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='장비 연결정보';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `equipment_connect`
--

LOCK TABLES `equipment_connect` WRITE;
/*!40000 ALTER TABLE `equipment_connect` DISABLE KEYS */;
INSERT INTO `equipment_connect` VALUES ('SV20240001','SV20240001',NULL),('SV20240001','SV20240001',NULL),('SV20240001','SV20240001',NULL),('SV20240001','SV20240001',NULL),('SV20240002','SV20240002',NULL),('SV20240002','SV20240002',NULL),('SV20240002','SV20240002',NULL),('SV20240003','SV20240003',NULL),('SV20240003','SV20240003',NULL),('SV20240003','SV20240003',NULL),('SV20240004','SV20240004',NULL),('SV20240004','SV20240004',NULL);
/*!40000 ALTER TABLE `equipment_connect` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-26  9:59:29
